	...
	<div class="wrapper">
          ...
          <span class="align-middle">Seller Dashboard</span>
              ...
              <i class="align-middle" data-feather="plus-circle"></i> <span class="align-middle">Create</span>
					...
					<li class="sidebar-item {{ request()->routeIs('vendor.manage') ? 'active' : '' }}">
						<a class="sidebar-link" href="{{route('vendor.manage')}}">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="{{asset('img/android-chrome-512x512.png')}}" class="avatar img-fluid rounded me-1" alt="Seller	" /> <span class="text-dark">Seller	</span>
              </a>
