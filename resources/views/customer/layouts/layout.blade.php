...
<head>
	...
	<title>@yield('custommer_page_title')</title>
	...
	<div class="wrapper">
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="{{asset('img/android-chrome-512x512.png')}}" class="avatar img-fluid rounded me-1" alt="User" /> <span class="text-dark">User</span>
              </a>
