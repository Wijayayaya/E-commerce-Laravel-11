	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
          ...
          <span class="align-middle">Admin Dashboard</span>
              ...
              <i class="align-middle" data-feather="gift"></i> <span class="align-middle">Discount</span>
            </a>
					</li>
				</ul>
				<form action="{{ route('home') }}" class="mb-3">
        			@csrf
		...
		<div class="main">
          ...
          <i class="hamburger align-self-center"></i>
                ...
                <img src="{{asset('img/android-chrome-512x512.png')}}" class="avatar img-fluid rounded me-1" alt="Admin" /> <span class="text-dark">Admin</span>
              </a>
