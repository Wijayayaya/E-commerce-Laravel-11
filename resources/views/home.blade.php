        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="{{asset('img/carousel/banner_1.jpg')}}" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.html">
                            //jangan Lupa nanti ganti ke gambar di database
                            <img src="{{asset('img/products_images/1683462523.jpg')}}" class="card-img-top" alt="..."> 
                        </a>
                        <div class="card-body">
